...
export const metadata: Metadata = {
  title: 'Winterdienst Mainz & Rheinhessen – Schneeräumung & Streuservice',
  description:
    'Zuverlässiger Winterdienst in Mainz, Alzey und Bad Kreuznach. Schneeräumung und Streuservice für Privat- und Gewerbekunden. Schnell, planbar und persönlich betreut.',
  keywords: [
    'Winterdienst Mainz',
    'Winterdienst Alzey',
    'Winterdienst Rheinhessen',
    'Schneeräumung Mainz',
    'Räumdienst Rheinhessen',
    'Streudienst Mainz',
    'Winterservice Rheinhessen',
  ],
  alternates: { canonical: '/leistungen/winterdienst' },
  openGraph: {
    title: 'Winterdienst Mainz & Rheinhessen | Green & Clean',
    description:
...
const service = SERVICES.find((s) => s.id === 'winterdienst')!
const page = SERVICE_PAGES.winterdienst
...
const serviceSchema = {
  ...
  description: 'Zuverlässiger Winterdienst in Rheinhessen: Schneeräumung und Streuservice für Privatgrundstücke, Hausverwaltungen und Gewerbeflächen.',
  url: 'https://www.greenundclean.com/leistungen/winterdienst',
}
